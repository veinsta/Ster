  ...
  return class StereoSound extends Plugin {
    ...
    settingsWarning() {
      ...
      if (
        ...
        // This would not work, noise reduction would be stuck to on. Also, nik made this work again. If you got this from a leak, you're a bitch.
    ...
    replacement(thisObj, _args, ret) {
      ...
      if (!this.settingsWarning()) {
        if (this.settings.enableToasts) {
               Toasts.info("Nik's Stereo Enabled");
        }
      }
      return ret;
    }
